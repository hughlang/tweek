...
impl MainState {
    fn new(ctx: &mut Context) -> GameResult<MainState> {
        ...
        let mut tween3 = Tween::with(IMAGE_ITEM_ID, &vec![&item3.frame, &item3.graphics.color])
        ...
        let mut tween4 = Tween::with(TEXT_ITEM_ID, &vec![&item4.frame, &item4.graphics.color])
