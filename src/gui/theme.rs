...
impl Default for Theme {
    fn default() -> Self {
        ...
        Theme {
            ...
            input_bg_color    : Color::from_hex("#0B253A"),
            input_fg_color    : Color::from_hex("#333333"),
            button_bg_color   : Color::from_hex("#7E57C2"),
...
impl ThemeBuilder {
    ...
    pub fn night_owl() -> Theme {
        ...
        Theme {
            ...
            button_bg_color: Color::from_hex("#7e57c2"), // button.background
    ...
    pub fn light_owl() -> Theme {
        ...
        Theme {
            ...
            input_fg_color     : Color::from_hex("#F0F0F0"), // input.foreground
            button_bg_color    : Color::from_hex("#2AA298"), // button.background
